...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotated_frame_path', type=str, default="resources/images/annotated_frame_keypoints_900.png")
    parser.add_argument('--annotated_frame_bbox_path', type=str, default="resources/images/annotated_frame_keypoints_bbox_900.png")
    ...
    annotated_frame_bbox_path = opt.annotated_frame_bbox_path
    ...
    # save the image with annotated keypoints
